...
public class UpComingAdapter extends RecyclerView.Adapter<UpComingAdapter.ViewHolder>{
    ...
    public UpComingAdapter(ArrayList<DataCatalog> dataCatalogs, Context context) {
    ...
    @Override
    public UpComingAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(UpComingAdapter.ViewHolder viewHolder, final int i) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.ratingCardView)RatingBar ratingBar;
        @BindView(R.id.frame_card)FrameLayout frameLayout;
