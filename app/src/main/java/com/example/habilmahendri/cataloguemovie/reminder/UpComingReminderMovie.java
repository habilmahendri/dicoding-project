package com.example.habilmahendri.cataloguemovie.reminder;
...
public class UpComingReminderMovie extends BroadcastReceiver {
    ...
    public void setReleaseReminderAlarm(Context context, String title) {
        ...
        Intent intent = new Intent(context, UpComingReminderMovie.class);
